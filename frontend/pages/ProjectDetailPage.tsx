...
const ProjectStatusBadge: React.FC<{ status: 'Open' | 'In Progress' | 'Completed' }> = ({ status }) => {
  const statusStyles = {
    'Open': { dot: 'bg-green-500', text: 'text-green-800', bg: 'bg-green-100', label: 'Otevřeno' },
    'In Progress': { dot: 'bg-yellow-500', text: 'text-yellow-800', bg: 'bg-yellow-100', label: 'Probíhá' },
    'Completed': { dot: 'bg-gray-500', text: 'text-gray-800', bg: 'bg-gray-100', label: 'Dokončeno' }
  };
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex flex-col sm:flex-row sm:flex-wrap gap-6 text-gray-700">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-semibold">Časový rámec</p>
        ...
        <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            >
              {project.status === 'Open' ? 'Podat žádost' : `Stav: ${project.status}`}
            </button>
            <button
              onClick={onChat}
