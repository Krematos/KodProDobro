...
export const BookmarkOutlineIcon = (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 20 20" stroke="currentColor" strokeWidth={2}>
     <path strokeLinecap="round" strokeLinejoin="round" d="M5 5a2 2 0 012-2h6a2 2 0 012 2v13l-4-2-4 2V5z" />
  </svg>
);
...
export const PROJECTS: Project[] = [
  {
    ...
    summary: 'Navrhněte a vytvořte mobilní aplikaci pro koordinaci dobrovolníků během krizových situací.',
    description: 'Cílem tohoto projektu je vytvořit intuitivní mobilní aplikaci pro iOS a Android, která pomůže koordinátorům ADRA efektivně řídit a komunikovat s dobrovolníky. Klíčové funkce by měly zahrnovat registraci na události, oznámení v reálném čase, přidělování úkolů a centrum zdrojů. Studenti získají zkušenosti s mobilním vývojem, UX/UI pro kritické aplikace a integrací backendu.',
    requiredSkills: ['React Native / Flutter', 'Firebase', 'UI/UX Design', 'Node.js (volitelné)'],
    timeline: '3-4 měsíce',
    commitment: '10-15 hodin/týden',
    deliverables: ['UI/UX Wireframy', 'Funkční prototyp', 'Plně funkční mobilní aplikace', 'Dokumentace backend API'],
    status: 'Open',
    tags: ['mobilní vývoj', 'sociální dopad', 'krizová reakce'],
    impactScore: 150,
    highlight: 'Doporučeno',
  },
  {
    id: 'p2',
    title: 'Redesign dárcovské platformy',
    organization: ORGANIZATIONS['red-cross'],
    summary: 'Přepracování hlavního dárcovského portálu pro Český červený kříž s cílem zlepšit uživatelskou zkušenost a zvýšit příspěvky.',
    description: 'Hledáme talentované webové vývojáře a designéry pro přepracování našeho stávajícího dárcovského webu. Současná stránka má nízký konverzní poměr. Nová platforma by měla být moderní, responzivní, bezpečná a poskytovat bezproblémový proces darování. Integrace platebních bran a panel pro dárce jsou klíčovými požadavky. Je to skvělá příležitost pracovat na webu s vysokou návštěvností a reálným dopadem.',
    requiredSkills: ['React / Vue.js', 'UI/UX Design', 'Stripe/PayPal API', 'Přístupnost (WCAG)'],
    timeline: '2 měsíce',
    commitment: '8-12 hodin/týden',
    deliverables: ['Zpráva z uživatelského výzkumu', 'High-fidelity mockupy', 'Responzivní webová stránka'],
    status: 'Open',
  ...
  },
  {
    ...
    summary: 'Vývoj interaktivní webové hry pro vzdělávání středoškoláků o problematice lidských práv.',
    description: 'Jako součást našeho vzdělávacího programu chceme vytvořit poutavou online hru, která studenty naučí o globálních lidských právech. Hra by měla obsahovat příběh, kvízy a scénáře rozhodování. Potřebujeme tým s dovednostmi v herním vývoji, ilustraci a webových technologiích, aby tuto vizi přivedl k životu. Projekt je podporován grantem Strategie AV21.',
    requiredSkills: ['JavaScript (Phaser, atd.)', 'Ilustrace', 'Storytelling', 'HTML5/CSS3'],
    timeline: '4 měsíce',
    commitment: '10 hodin/týden',
    deliverables: ['Design dokument hry', 'Hratelné demo', 'Finální webová hra'],
    status: 'In Progress',
...
export const CURRENT_USER: User = {
  ...
  fieldOfStudy: 'Informatika a výpočetní technika',
...
export const MOCK_CHAT_MESSAGES: Record<string, ChatMessage[]> = {
    'chat1': [
        { id: 1, sender: 'other', text: 'Dobrý den Jano, děkujeme za váš zájem o projekt Mobilní aplikace pro správu dobrovolníků!', timestamp: '10:01', avatar: ORGANIZATIONS.adra.logoUrl },
        { id: 2, sender: 'other', text: 'Váš profil vypadá jako skvělá shoda. Máte nějaké zkušenosti s Firebase?', timestamp: '10:02', avatar: ORGANIZATIONS.adra.logoUrl },
        { id: 3, sender: 'user', text: 'Dobrý den! Děkuji za zprávu. Ano, Firebase jsem použila pro autentizaci a Firestore v několika osobních projektech.', timestamp: '10:05', avatar: CURRENT_USER.avatarUrl },
        { id: 4, sender: 'user', text: 'Jsem opravdu nadšená z potenciálu této aplikace.', timestamp: '10:05', avatar: CURRENT_USER.avatarUrl },
        { id: 5, sender: 'other', text: 'Skvělé! To rádi slyšíme. Rádi bychom si domluvili krátký hovor, abychom projekt probrali podrobněji. Máte čas někdy zítra odpoledne?', timestamp: '10:10', avatar: ORGANIZATIONS.adra.logoUrl },
    ],
    'chat2': [
        { id: 1, sender: 'other', text: 'Dobrý den Jano, děkujeme, že jste se přihlásila k projektu Redesign dárcovské platformy.', timestamp: 'Včera', avatar: ORGANIZATIONS['red-cross'].logoUrl },
...
export const GAMIFICATION_BADGES: AIBadge[] = [
    ...
    {
        name: 'Lídr dopadu',
        description: 'Uděleno za vedení týmu k úspěšnému dokončení projektu.',
