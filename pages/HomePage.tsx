  ...
  return (
    <div>
      ...
      <div className="mb-4 relative">
          <input
              type="text"
              placeholder="Search for projects, orgs, or tags..."
              value={searchQuery}
      ...
      <div className="mb-6 bg-white p-4 rounded-lg shadow-sm border border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
               ...
               <div>
                   <label htmlFor="org-filter" className="block text-sm font-medium text-gray-700 mb-2">Filter by Organization</label>
                    <select
                        id="org-filter"
              ...
              <div>
                   <label htmlFor="skill-filter" className="block text-sm font-medium text-gray-700 mb-2">Filter by Skill</label>
                    <select
                        id="skill-filter"
                        value={skillFilter}
      ...
      <h2 className="text-2xl font-bold text-brand-dark mb-4">
        {statusFilter !== 'All' ? `${statusFilter} Projects` : 'All Projects'}
      </h2>
        ...
        {filteredProjects.length > 0 ? (
          filteredProjects.map(project => (
           ...
           <div className="text-center py-10 px-6 bg-white rounded-lg shadow-md">
             <h3 className="text-xl font-semibold text-brand-dark">No Projects Found</h3>
